...
if plr.Character:FindFirstChild("Torso") then
	...
	plr.Character.RightUpperArm["RightShoulder"]:Destroy()
	plr.Character.LeftUpperArm["LeftShoulder"]:Destroy()
	plr.Character.RightUpperLeg["RightHip"]:Destroy()
	plr.Character.LeftUpperLeg["LeftHip"]:Destroy()
end

local left_arm = plr.Character:FindFirstChild("Left Arm") or plr.Character:FindFirstChild("LeftUpperArm")
local right_arm = plr.Character:FindFirstChild("Right Arm") or plr.Character:FindFirstChild("RightUpperArm")
local torso = plr.Character:FindFirstChild("Torso") or plr.Character:FindFirstChild("UpperTorso")
local right_leg = plr.Character:FindFirstChild("Right Leg") or plr.Character:FindFirstChild("RightUpperLeg")
local left_leg = plr.Character:FindFirstChild("Left Leg") or plr.Character:FindFirstChild("LeftUpperLeg")


plr.Character.Head.CanCollide = false

plr.Character.Head:GetPropertyChangedSignal("CanCollide"):Connect(function()
	plr.Character.Head.CanCollide = false
end)
...
if plr.Character:FindFirstChild("LowerTorso") then
	...
	plr.Character.LowerTorso:GetPropertyChangedSignal("CanCollide"):Connect(function()
		plr.Character.LowerTorso.CanCollide = false
	end)
	
	plr.Character.UpperTorso.CanCollide = false
	
	plr.Character.UpperTorso:GetPropertyChangedSignal("CanCollide"):Connect(function()
		plr.Character.UpperTorso.CanCollide = false
	end)
else
	plr.Character.Torso.CanCollide = false
	
	plr.Character.Torso:GetPropertyChangedSignal("CanCollide"):Connect(function()
		plr.Character.Torso.CanCollide = false
	end)
end
...
char.Parent = plr.Character.Parent
...
local function nocollision(prt)
...
weldm(left_arm, char["Left Arm"], CFrame.Angles(0, 0, 0))
weldm(right_arm, char["Right Arm"], CFrame.Angles(0, 0, 0))
weldm(left_leg, char["Left Leg"], CFrame.Angles(0, 0, 0))
weldm(right_leg, char["Right Leg"], CFrame.Angles(0, 0, 0))
weldm(torso, char["Torso"], CFrame.new(0, 0.5, 0))

char:MoveTo(plr.Character.HumanoidRootPart.CFrame.Position)
...
local render_stepped = game.RunService.RenderStepped:Connect(function()
...
on_died = char.Humanoid.Died:Connect(function()
	plr.Character = oc
